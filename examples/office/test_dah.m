function[] = test_dah()
% TEST_DAH Evaluate Classification error with Domain Adaptive Hash
...
imdbPath = [dataRoot, src_tgt, '-vgg-dah/', imdbFile];
opts.saveFilePath = [dataRoot, src_tgt, '-vgg-dah/','fortSNE.mat'];
net = load(netPath);
net = net.net;
...
fprintf('BoostedSrcAcc %0.2f, BoostedTgtAcc %0.2f, 1-NN %0.2f, Hamm1NN %0.2f, Hamm10NN %0.2f, srcMap %0.3f, tgtMap %0.3f\n', ...
    boostedSAcc, boostedTAcc, oneNNacc, hamm1acc, hamm10acc, srcMap, tgtMap);
fprintf('BoostedSrcAcc, BoostedTgtAcc, 1-NN, Hamm1NN, Hamm10NN, srcMap, tgtMap\n');
fprintf('%0.2f, %0.2f, %0.2f, %0.2f, %0.2f, %0.3f, %0.3f\n', ...
    boostedSAcc, boostedTAcc, oneNNacc, hamm1acc, hamm10acc, srcMap, tgtMap);
